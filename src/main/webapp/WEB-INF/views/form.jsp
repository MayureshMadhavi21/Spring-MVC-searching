			...
			<div class="col-md-6 offset-md-3">
				<div class="card-body">
					...
					<form action="handleForm" method="post">
						...
						<div class="form-group">
							<label for="exampleInputEmail">Your DOB</label> <input name="dob"
								type="date" class="form-control" id="exampleInputEmail"
								placeholder="dd/mm/yyyy">
						</div>
						<div class="form-group">
							<label for="exampleFormControlSelect1">Example Course</label> <select
								name="subjects" class="form-control" id="exampleInputEmail"
								multiple>
								<option>Java</option>
								<option>Db</option>
								<option>JS</option>
						...
						<div class="form-group">
							<label for="exampleFormControlSelect1">Select type</label> <select
								name="type" class="form-control" id="exampleInputEmail">
